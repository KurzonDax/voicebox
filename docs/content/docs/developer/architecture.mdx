...
See [TTS Engines](/developer/tts-engines) for the full contract and integration phases, and [PROJECT_STATUS.md](https://github.com/KurzonDax/voicebox/blob/main/docs/PROJECT_STATUS.md) for candidates under evaluation.
