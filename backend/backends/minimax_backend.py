...
class MiniMaxTTSBackend:
    ...
    async def combine_voice_prompts(
        ...
        raise NotImplementedError(
            "MiniMax Cloud TTS uses preset voice IDs and does not support voice cloning from reference audio."
        )
    ...
    async def generate(
        ...
        def _generate_sync() -> tuple[np.ndarray, int]:
            ...
            try:
                ...
                raise RuntimeError(f"MiniMax TTS API error ({e.code}): {error_body}") from e
